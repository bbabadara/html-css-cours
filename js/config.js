...
const CONFIG = {
  ...
  navItems: [
    ...
    { id: 'html-best-practices', name: 'Bonnes Pratiques', icon: '✨', chapter: '2.1.4', type: 'html' },
    { id: 'html-text', name: 'Titres & Paragraphes', icon: '📝', chapter: '2.1.5', type: 'html' },
    { id: 'html-formatting', name: 'Formatage Texte', icon: '🎨', chapter: '2.1.6', type: 'html' },
    { id: 'html-lists', name: 'Listes', icon: '📋', chapter: '2.1.7', type: 'html' },
    { id: 'html-definition-lists', name: 'Listes Définitions', icon: '📖', chapter: '2.1.8', type: 'html' },
    { id: 'html-nested-lists', name: 'Listes Imbriquées', icon: '🔀', chapter: '2.1.9', type: 'html' },
    { id: 'html-links', name: 'Liens', icon: '🔗', chapter: '2.1.10', type: 'html' },
